...
const NIVEL_KEY = 35;  // ← Evaluación Final
...
/* =========================================================
   PREGUNTAS — Evaluación Final Lectura de Orden de Fabricación
   (25 preguntas; las opciones se muestran en orden aleatorio
    en cada intento gracias al shuffle)
========================================================= */
const QUESTIONS_BASE: Question[] = [
  {
    id: 1, type: "single",
    text: "¿Cuál es el número de la Orden de Fabricación?",
    options: [
      { key: "a", label: "10525980" },
      { key: "b", label: "10525090" },
      { key: "c", label: "10525900" },
    ],
    correct: "b",
  },
  {
    id: 2, type: "single",
    text: "¿Cuántos lites tiene la pieza en el área de Corte?",
    options: [
      { key: "a", label: "4" },
      { key: "b", label: "5" },
      { key: "c", label: "6" },
  ...
  {
    id: 3, type: "single",
    text: "¿Cuáles son los espesores de los lites?",
    options: [
      { key: "a", label: "6-6-5-3-5-6 mm" },
      { key: "b", label: "6-6-6-3-5-6 mm" },
      { key: "c", label: "5-5-5-3-5-6 mm" },
      { key: "d", label: "6-5-6-3-6-5 mm" },
    ],
    correct: "b",
  },
  {
    id: 4, type: "single",
    text: "¿Qué tipos de cristal requiere la orden?",
    options: [
      { key: "a", label: "Cristal Sodalime y Gris Dark" },
      { key: "b", label: "Cristal White y Sodalime" },
      { key: "c", label: "Cristal Incoloro y Alluminum" },
    ],
    correct: "a",
  },
  {
    id: 5, type: "single",
    text: "¿Para qué vehículo es la pieza?",
    options: [
      { key: "a", label: "Toyota Hilux 2010" },
      { key: "b", label: "Toyota Prado 4D Utility 2010" },
      { key: "c", label: "Toyota Prado 2D Utility 2010" },
    ],
    correct: "b",
  },
  {
    id: 6, type: "single",
    text: "¿Qué pieza corresponde?",
    options: [
      { key: "a", label: "Lateral Extendido" },
      { key: "b", label: "Posterior" },
      { key: "c", label: "Cabina delantera Izquierda" },
    ],
    correct: "b",
  },
  {
    id: 7, type: "single",
    text: "¿Cuál es el nivel de la pieza?",
    options: [
      { key: "a", label: "01" },
      { key: "b", label: "04" },
      { key: "c", label: "03" },
  ...
  {
    id: 8, type: "single",
    text: "¿Contra qué norma se comparan los defectos?",
    options: [
      { key: "a", label: "OEM" },
      { key: "b", label: "DOT" },
      { key: "c", label: "Retrofit" },
    ],
    correct: "c",
  },
  {
    id: 9, type: "single",
    text: "¿La pieza tiene acero?",
    options: [
      { key: "a", label: "SI" },
      { key: "b", label: "NO" },
    ],
  ...
  {
    id: 10, type: "single",
    text: "Cantidad de radios vidrio paquete",
    options: [
      { key: "a", label: "3" },
      { key: "b", label: "4" },
      { key: "c", label: "6" },
  ...
  {
    id: 11, type: "single",
    text: "Cantidad de radios vidrio pintura",
    options: [
      { key: "a", label: "3" },
      { key: "b", label: "4" },
      { key: "c", label: "6" },
  ...
  {
    id: 13, type: "single",
    text: "¿Cuántos puntos de control de Offset tiene?",
    options: [
      { key: "a", label: "2" },
      { key: "b", label: "3" },
      { key: "c", label: "4" },
  ...
  {
    id: 14, type: "single",
    text: "¿Cuál es el código del logo?",
    options: [
      { key: "a", label: "817" },
      { key: "b", label: "807" },
      { key: "c", label: "718" },
  ...
  {
    id: 15, type: "single",
    text: "¿Quién pone el logo?",
    options: [
      { key: "a", label: "Corte" },
      { key: "b", label: "CNC" },
      { key: "c", label: "Serigrafía" },
      { key: "d", label: "Curvado" },
    ],
    correct: "c",
  },
  {
    id: 16, type: "single",
    text: "¿Qué le da el color a la pieza?",
    options: [
      { key: "a", label: "El cristal únicamente" },
      { key: "b", label: "El PVB" },
      { key: "c", label: "Los plásticos y el tipo de lite" },
    ],
    correct: "a",
  },
  {
    id: 17, type: "single",
    text: "¿Cuántos plásticos tiene la pieza?",
    options: [
      { key: "a", label: "10" },
      { key: "b", label: "8" },
      { key: "c", label: "5" },
  ...
  {
    id: 18, type: "single",
    text: "¿Cuáles son las medidas de las cuerdas?",
    options: [
      { key: "a", label: "Horizontal 1237 - Vertical 569" },
      { key: "b", label: "Horizontal 1323 - Vertical 564" },
      { key: "c", label: "Horizontal 1232 - Vertical 596" },
    ],
    correct: "b",
  },
  {
    id: 19, type: "single",
    text: "¿La pieza tiene bomba?",
    options: [
      { key: "a", label: "SI" },
      { key: "b", label: "NO" },
    ],
  ...
  {
    id: 20, type: "single",
    text: "¿Cuál es la medida de la bomba?",
    options: [
      { key: "a", label: "Bomba A 12.00" },
      { key: "b", label: "Bomba B 10.00" },
      { key: "c", label: "Bomba B 12.00" },
      { key: "d", label: "Bomba C 12.00" },
    ],
    correct: "c",
  },
  {
    id: 21, type: "single",
    text: "¿Cuál es la tolerancia de aceptación de la bomba?",
    options: [
      { key: "a", label: "±1 mm" },
      { key: "b", label: "±3 mm" },
      { key: "c", label: "±2 mm" },
  ...
  {
    id: 22, type: "single",
    text: "¿La pieza lleva red o antena?",
    options: [
      { key: "a", label: "SI" },
      { key: "b", label: "NO" },
    ],
  ...
  {
    id: 23, type: "single",
    text: "¿Cómo se pinta la pieza?",
    options: [
      { key: "a", label: "Malla" },
      { key: "b", label: "Vitrojet" },
      { key: "c", label: "Malla y Vitrojet" },
      { key: "d", label: "No lleva pintura" },
    ],
    correct: "c",
  },
  {
    id: 24, type: "single",
    text: "¿Qué tipo de molde pide la orden?",
    options: [
      { key: "a", label: "Molde Lleno" },
      { key: "b", label: "Molde Plano" },
      { key: "c", label: "Molde Anillo" },
    ],
    correct: "a",
  },
  {
    id: 25, type: "single",
    text: "¿La pieza tiene VIN?",
    options: [
      { key: "a", label: "SI" },
      { key: "b", label: "NO" },
    ],
...
const MATRIX_LABEL_W  = scaleDP(130);
const MATRIX_COL_W    = scaleDP(60);
const MATRIX_ROW_H    = scaleDP(36);
const MATRIX_FONT     = scaleDP(11);
const MATRIX_HEADER_F = scaleDP(10);
const MATRIX_RADIO    = scaleDP(16);
const MATRIX_RADIO_IN = scaleDP(8);

export default function NivelEvaluacionFinalLecturaOF() {
  ...
  const isMultiCorrect  = (sel: KeyOpt[], cor: KeyOpt[]) => sel.length === cor.length && [...sel].sort().every((x, i) => x === [...cor].sort()[i]);
        ...
        <View style={st.header}>
          <View style={st.introBox}>
            ...
            <Text style={st.descripcionIntro}>
              Llegaste al cierre del recorrido de Lectura de Orden de Fabricación.{"\n\n"}
              Responde las preguntas sobre la OF: número de orden, lites, espesores, cristales, radios, offset, logo, cuerdas, bombas, pintura y molde.{"\n\n"}
        ...
        <View style={st.overlay}>
          <View style={st.podioBox}>
            <View style={st.podioHeader}>
              <Text style={st.podioTitle}>🏆 Podio Lectura OF</Text>
