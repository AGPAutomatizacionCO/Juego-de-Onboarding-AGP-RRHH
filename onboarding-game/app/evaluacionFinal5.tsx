...
type MatrixColumn = "zona_a" | "zona_b" | "zona_c";
...
/* =========================================================
   PREGUNTAS
   5 preguntas basadas en las presentaciones de Calidad
   y Manejo de Signos y Tolerancias
========================================================= */
const QUESTIONS_BASE: Question[] = [

  // ── Pregunta 1: Metodología de inspección (multi) ──────
  {
    id: 1, type: "multi",
    text: "¿Cuáles son los pasos correctos de la metodología de inspección de calidad en AGP?",
    options: [
      { key: "a", label: "Identificar el defecto" },
      { key: "b", label: "Ubicar el defecto (Zona A, B o C)" },
      { key: "c", label: "Medir el defecto" },
      { key: "d", label: "Comparar con la norma" },
      { key: "e", label: "Tomar decisión" },
      { key: "f", label: "Reportar al turno siguiente" },
    ],
    correct: ["a", "b", "c", "d", "e"],
  },

  // ── Pregunta 2: Zonas del vidrio (matrix) ──────────────
  {
    id: 2, type: "matrix",
    text: "Relacione cada zona del vidrio con su nivel de criticidad en visibilidad de defectos",
    columns: [
      { key: "zona_a", label: "Zona A — Azul" },
      { key: "zona_b", label: "Zona B — Verde" },
      { key: "zona_c", label: "Zona C — Fucsia" },
    ],
    rows: [
      { id: "r1", label: "Criticidad ALTA — área de cámara, sensor y espejos retrovisores", correct: "zona_a" },
      { id: "r2", label: "Criticidad MEDIA — área central visible del vidrio",               correct: "zona_b" },
      { id: "r3", label: "Criticidad BAJA — bordes y zonas externas del vidrio",             correct: "zona_c" },
    ],
  },

  // ── Pregunta 3: Criterios de aceptación (single) ───────
  {
    id: 3, type: "single",
  ...
  // ── Pregunta 4: Tolerancias (single) ───────────────────
  {
    id: 4, type: "single",
    text: "En una especificación de 3,25 ± 0,5 mm, ¿cuáles son el Límite Superior (LSE) y el Límite Inferior (LIE) de aceptación?",
    options: [
      { key: "a", label: "LSE: 3,30 mm — LIE: 3,20 mm" },
      { key: "b", label: "LSE: 3,55 mm — LIE: 2,85 mm" },
      { key: "c", label: "LSE: 3,75 mm — LIE: 2,75 mm" },
      { key: "d", label: "LSE: 3,50 mm — LIE: 3,00 mm" },
    ],
    correct: "c",
  },

  // ── Pregunta 5: Signos de comparación (multi) ──────────
  {
    id: 5, type: "multi",
    text: "¿Cuáles de las siguientes afirmaciones son VERDADERAS?",
    options: [
      { key: "a", label: "110 mm  >  90 mm  →  VERDADERA" },
      { key: "b", label: "1,2 mm  >  0,8 mm  →  VERDADERA" },
      { key: "c", label: "225 mm  <  115 mm  →  VERDADERA" },
      { key: "d", label: "225 mm  <  115 mm  →  FALSA" },
      { key: "e", label: "0,8 mm  >  1,2 mm  →  VERDADERA" },
    ],
    correct: ["a", "b", "d"],
  },
];
...
const MATRIX_LABEL_W  = scaleDP(200);
const MATRIX_COL_W    = scaleDP(120);
...
========================================================= */
export default function NivelEvaluacionFinalCalidad() {
        ...
        <View style={st.header}>
          <View style={st.introBox}>
            ...
            <Text style={st.descripcionIntro}>
              Llegaste al cierre del recorrido de Calidad.{"\n\n"}
              Responde las preguntas sobre metodología de inspección, zonas del vidrio, criterios de aceptación, tolerancias y signos de comparación.{"\n\n"}
        ...
        <View style={st.overlay}>
          <View style={st.podioBox}>
            <View style={st.podioHeader}>
              <Text style={st.podioTitle}>🏆 Podio Calidad</Text>
