...
const preguntasDefault = [
  { id: 1, texto: "Si quiero medir el vacío en una pieza, yo utilizo un ", respuesta: "Vacuómetro" as OpcionRespuesta },
  { id: 2, texto: "El instrumento adecuado para realizar mediciones superiores a 300 mm es el", respuesta: "Flexómetro" as OpcionRespuesta },
  { id: 3, texto: "Es un instrumento que nos sirve para medir espesores con una gran precisión", respuesta: "Micrómetro" as OpcionRespuesta },
  { id: 4, texto: "Con este instrumento realizamos la medición de la separación del vidrio con respecto a un molde o galga", respuesta: "Taper Gauge" as OpcionRespuesta },
...
export default function NivelLecturaProcesos() {
  ...
  [`u:${uk}:isla${ISLA_KEY}_nivel${NIVEL_KEY_API}_lectura_done`, "true"],
  [`u:${uk}:isla${ISLA_KEY}_nivel${NIVEL_KEY_API}_lectura_score`, String(score)],
  [`u:${uk}:isla${ISLA_KEY}_nivel28_lectura_unlocked`, "true"],
]);
      ...
      {alreadyPlayed && savedScore !== null && (
        <View style={styles.header}>
          <View style={styles.introBox}>
            <Text style={styles.titulo}>Nivel Lectura – Metrología</Text>
...
const styles = StyleSheet.create({
  ...
  gameContainer: { flex: 1, alignItems: "center", paddingHorizontal: scaleDP(30), paddingBottom: scaleDP(10) },

  boardArea: {
    width: "100%",
    alignItems: "center",
    marginTop: scaleDP(80),
  },
  board: {
    width: "97%",
    backgroundColor: "#fff",
