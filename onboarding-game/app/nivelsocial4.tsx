...
const casosBase: CasoBase[] = [
  {
    id: 1,
    pregunta: "Si usas la marcación del corte como guía, ¿en qué cara debe trabajarse el lite para hacer la banda negra y el degradé?",
    opciones: [
      "En la cara al aire, lado contrario a la marcación del corte",
      "En la cara estañada, lado más cercano a la marcación del corte",
  ...
  {
    id: 2,
    pregunta: "Antes de pintar, la orden de fabricación indica que la pieza debe trabajarse como Caso 2. ¿Qué debes identificar?",
    opciones: [
      "Que la pieza es brillante por un lado y opaca por el otro",
      "Que la pieza es brillante por ambos lados",
      "Que el acabado se define después de pintar",
    ],
    correctaIdx: 0,
  },
  {
    id: 3,
    pregunta: "Cuando en la orden de fabricación aparece la letra R, ¿cuál es el molde que se debe usar?",
    opciones: ["Molde lleno", "Molde anillo", "Cualquiera de los dos"],
    correctaIdx: 0,
  },
  {
    id: 4,
    pregunta: "Al revisar la pieza, observas que el acero no va dentro del paquete, sino a ras del offset. ¿Qué tipo de marco corresponde?",
    opciones: ["Marco de acero sin empotrar", "Marco de acero empotrado", "Marco interno"],
    correctaIdx: 0,
  },
  {
    id: 5,
    pregunta: "Te entregan dos lites muy parecidos y debes confirmar cuál corresponde a la orden de fabricación. ¿Cómo puedes diferenciarlos?",
    opciones: ["Revisando radios, espesores y degradé", "Solo revisando el tamaño", "Solo guiándote por el logo"],
    correctaIdx: 0,
  },
];
...
/* =========================================================
   COMPONENTE
========================================================= */
export default function NivelSaltoVidrios() {
  ...
  */
      ...
      {showIntro && (
        <View style={styles.centeredFull}>
          <View style={styles.introBox}>
            <Text style={styles.introTitle}>Nivel – Salto de Vidrios</Text>
            <Text style={styles.introDesc}>
              En este nivel deberás responder {casosData.length} preguntas sobre el proceso.{"\n\n"}
  ...
  <View
    style={[
      styles.jumpBox,
      color === "green" && styles.jumpBoxCorrect,
      color === "red" && styles.jumpBoxWrong,
    ]}
  >
    <Text
      style={[
