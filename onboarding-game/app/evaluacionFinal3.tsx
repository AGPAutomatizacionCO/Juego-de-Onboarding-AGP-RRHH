...
type MatrixColumn = "uma1" | "uma2" | "uma3" | "uma4" | "uma5" | "uma6" | "calidad";
...
const QUESTIONS_BASE: Question[] = [
  {
    id: 1, type: "multi",
    text: "¿Cuáles son los procesos de producción que se trabajan en AGP?",
    options: [
      { key: "a", label: "Corte" }, { key: "b", label: "Serigrafía" }, { key: "c", label: "Curvado" },
      { key: "d", label: "Empalme" }, { key: "e", label: "Autoclave" }, { key: "f", label: "Pulido manual" },
      { key: "g", label: "Brillado de banda negra" }, { key: "h", label: "Diseño de planos" }, { key: "i", label: "Vitrilio" },
    ],
    correct: ["a", "b", "c", "d", "e", "f"],
  },
  {
    id: 2, type: "multi",
    text: "¿De qué manera se encuentran distribuidos los procesos de producción?",
    options: [
      { key: "a", label: "UMAS" }, { key: "b", label: "Bloques" }, { key: "c", label: "Divisiones" },
      { key: "d", label: "Frentes de trabajo" }, { key: "e", label: "Expertos" }, { key: "f", label: "Supervisores" },
    ],
    correct: ["a", "b"],
  },
  {
    id: 3, type: "matrix",
    text: "Relacione los procesos según la UMA a la cual corresponde",
    columns: [
    ...
    rows: [
      { id: "r1", label: "Corte y mecanizado", correct: "uma1" }, { id: "r2", label: "Serigrafía", correct: "uma2" },
      { id: "r3", label: "Curvado", correct: "uma3" }, { id: "r4", label: "Recorte", correct: "uma4" },
      { id: "r5", label: "Corte PC", correct: "uma5" }, { id: "r6", label: "Embolsado", correct: "uma6" },
      { id: "r7", label: "Acabado", correct: "calidad" },
    ],
  },
  {
    id: 4, type: "single",
    text: "¿Qué se realiza en el proceso de empalme?",
    options: [
      { key: "a", label: "Se aplica talco en las superficies de los cristales." },
      { key: "b", label: "Se adhiere la pintura a los cristales." },
      { key: "c", label: "Se exponen los cristales a una alta temperatura para que tomen la curvatura requerida." },
      { key: "d", label: "Se valida que los cristales no tengan rayones ni distorsiones." },
    ],
    correct: "a",
  },
  {
    id: 5, type: "single",
    text: "¿Cuál es el orden del seguimiento de colores que se debe manejar en planta?",
    options: [
      { key: "a", label: "Negro, rojo, amarillo y verde" }, { key: "b", label: "Verde, amarillo, rojo y negro" },
      { key: "c", label: "Azul, amarillo, rojo y negro" }, { key: "d", label: "Negro, rojo, amarillo y azul" },
    ],
    correct: "a",
  },
  {
    ...
    options: [
      { key: "a", label: "Trabajar con calidad y velocidad" }, { key: "b", label: "Usar los EPPS" },
      { key: "c", label: "Seguimiento código de prioridades" }, { key: "d", label: "Cumplimiento al cliente" },
      { key: "e", label: "Espíritu de mejora continua" },
    ],
    correct: ["a", "b", "e"],
  },
];
...
export default function NivelEvaluacionFinalProduccion() {
        ...
        <View style={st.header}>
          <View style={st.introBox}>
            ...
            <Text style={st.descripcionIntro}>
              Llegaste al cierre del recorrido de procesos de producción.{"\n\n"}
              Responde las preguntas sobre procesos, distribución por UMAS, empalme, prioridades y no negociables.{"\n\n"}
        ...
        <View style={st.overlay}>
          <View style={st.podioBox}>
            <View style={st.podioHeader}>
              <Text style={st.podioTitle}>🏆 Podio Procesos</Text>
