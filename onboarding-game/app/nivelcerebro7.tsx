/**
 * Nivel Recordemos — Sopa de letras (Manipulación del Vidrio - Isla 5)
 */
...
const NIVEL_KEY = 23;  // ← Nivel Recordemos
...
// GALGASVERIFICACION tiene 18 letras, por eso la cuadrícula es 18x18
const GRID_N   = 18;
const MAX_HINTS = 5;

/* =========================================================
   PALABRAS — Manipulación del Vidrio (contenido fijo)
========================================================= */
const WORDS_DEFAULT: WordInfo[] = [
  { palabra: "SET",                concepto: "Conjunto de todas las piezas blindadas de un mismo vehículo." },
  { palabra: "MOLDEANILLO",       concepto: "Herramental utilizado para piezas con doble curvatura esférica." },
  { palabra: "SUNROOF",            concepto: "Pieza ubicada en la parte superior del vehículo." },
  { palabra: "OFFSET",             concepto: "Distancia entre vidrio pintura y vidrio maquete que facilita el montaje del vidrio en el vehículo." },
  { palabra: "GALGASVERIFICACION", concepto: "Herramienta que permite verificar si la pieza quedó con la curvatura adecuada según la orden de fabricación." },
  { palabra: "CARAESTAÑADA",       concepto: "Superficie más cercana a la marcación del corte." },
  { palabra: "CARAALAIRE",         concepto: "Superficie opuesta a la marcación del corte." },
  { palabra: "PARTICION",          concepto: "Vidrio blindado ubicado dentro del vehículo que separa a los pasajeros del baúl." },
];
...
export default function NivelCerebroManipulacion() {
  ...
  // ── Contenido fijo (sin BD por ahora): se usan directamente WORDS_DEFAULT ──
  ...
  const guardarCompletado = async () => {
    try {
      ...
      await AsyncStorage.multiSet([
        ...
        [keyU(`isla${ISLA_KEY}_nivel24_social_unlocked`),            "true"],
      ]);
        ...
        {phase === "intro" && (
          <View style={st.introWrap}>
            <View style={st.introCard}>
              <Text style={st.introH}>Nivel Recordemos – Manipulación del Vidrio</Text>
              <Text style={st.introP}>
                En este nivel reforzarás los conceptos clave de la manipulación del vidrio en AGP.{"\n\n"}
