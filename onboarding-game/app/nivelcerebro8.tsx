/**
 * Nivel Recordemos — Sopa de letras (Lectura de Orden de Fabricación - Isla 7)
 */
...
const NIVEL_KEY = 33;  // ← Nivel Recordemos
...
/* =========================================================
   PALABRAS — Lectura de Orden de Fabricación (contenido fijo)
========================================================= */
const WORDS_DEFAULT: WordInfo[] = [
  { palabra: "SUNROOF",    concepto: "Pieza de vidrio ubicada en la parte superior del vehículo." },
  { palabra: "QDD",        concepto: "Abreviatura de Cabina delantera derecha." },
  { palabra: "MIRILLA",    concepto: "Número de pieza 17." },
  { palabra: "NEGRO",      concepto: "Color que indica que estamos muy fuera de tiempo y con el mayor retraso." },
  { palabra: "PBS",        concepto: "Vidrio frontal del vehículo que protege al conductor." },
  { palabra: "AMARILLO",   concepto: "Color que advierte que estamos próximos a incumplir la fecha." },
  { palabra: "FRAGATTA",   concepto: "Número de pieza 42." },
  { palabra: "PARTICION",  concepto: "Número de pieza 30." },
  { palabra: "CARAALAIRE", concepto: "Cara opuesta a la marcación del corte." },
  { palabra: "ZIGZAG",     concepto: "Forma correcta de inspeccionar una pieza de vidrio." },
];
...
export default function NivelCerebroLecturaOF() {
  ...
  const [words] = useState<WordInfo[]>(WORDS_DEFAULT);
        ...
        {phase === "intro" && (
          <View style={st.introWrap}>
            <View style={st.introCard}>
              <Text style={st.introH}>Nivel Recordemos – Lectura de OF</Text>
              <Text style={st.introP}>
                En este nivel reforzarás los conceptos clave de la lectura de la Orden de Fabricación.{"\n\n"}
