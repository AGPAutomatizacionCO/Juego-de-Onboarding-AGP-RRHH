...
type MatrixColumn = "voltios" | "amperios" | "ohmios";
...
/* =========================================================
   PREGUNTAS — 5 basadas en la evaluación de Metrología
========================================================= */
const QUESTIONS_BASE: Question[] = [

  // ── P1: Partes del pie de rey (multi) ──────────────────
  {
    id: 1, type: "multi",
    text: "¿Cuáles son las partes del pie de rey? Escoge las opciones correctas.",
    options: [
      { key: "a", label: "Puntas Exteriores" },
      { key: "b", label: "Puntas Interiores" },
      { key: "c", label: "Barra de profundidad" },
      { key: "d", label: "Regla fija con escala en mm" },
      { key: "e", label: "Regla Nonio" },
      { key: "f", label: "Seguro" },
    ],
    correct: ["a", "b", "c", "d", "e", "f"],
  },

  // ── P2: Medida final pie de rey (single) ───────────────
  {
    id: 2, type: "single",
    text: "Para obtener la medida final del pie de rey / Profundímetro, ¿qué debemos tener en cuenta?",
    options: [
      { key: "a", label: "Escala terciaria y puntas exteriores" },
      { key: "b", label: "Escala principal y nonio" },
      { key: "c", label: "Escala secundaria y nonio" },
      { key: "d", label: "Solo la escala principal" },
    ],
    correct: "b",
  },

  // ── P3: Relación magnitudes eléctricas (matrix) ────────
  {
    id: 3, type: "matrix",
    text: "Relacione cada magnitud eléctrica con su unidad de medida correspondiente",
    columns: [
      { key: "voltios",   label: "Voltios"   },
      { key: "amperios",  label: "Amperios"  },
      { key: "ohmios",    label: "Ohmios"    },
    ],
    rows: [
      { id: "r1", label: "Tensión",     correct: "voltios"  },
      { id: "r2", label: "Corriente",   correct: "amperios" },
      { id: "r3", label: "Resistencia", correct: "ohmios"   },
    ],
  },

  // ── P4: Micrómetro en cero (single) ────────────────────
  {
    id: 4, type: "single",
    text: "Al utilizar el micrómetro observas que muestra 0,08 mm cuando debería estar en cero. ¿Qué debes hacer?",
    options: [
      { key: "a", label: "Retirar la pila y volver a instalarla." },
      { key: "b", label: "Continuar usando el micrómetro y restar manualmente la diferencia." },
      { key: "c", label: "Presionar el botón ZERO/ABS para ajustar a cero." },
      { key: "d", label: "Apagar el instrumento y dejarlo reposar 30 minutos antes de volver a usarlo." },
    ],
    correct: "c",
  },

  // ── P5: Uso correcto del flexómetro (single) ───────────
  {
    id: 5, type: "single",
    text: "¿Cuál es la forma correcta de utilizar un flexómetro para garantizar mediciones precisas y evitar su deterioro?",
    options: [
      { key: "a", label: "Extender completamente la cinta y soltarla de golpe al recogerla." },
      { key: "b", label: "Asegurarse de que la cinta esté recta y fija durante la medición." },
      { key: "c", label: "Usar la cinta como herramienta para cortar o marcar materiales." },
      { key: "d", label: "Dejar la cinta bajo tensión después de cada uso para ahorrar tiempo." },
    ],
    correct: "b",
  },
];
...
========================================================= */
export default function NivelEvaluacionFinalMetrologia() {
        ...
        <View style={st.header}>
          <View style={st.introBox}>
            ...
            <Text style={st.descripcionIntro}>
              Llegaste al cierre del recorrido de Metrología.{"\n\n"}
              Responde las preguntas sobre partes del pie de rey, lectura de instrumentos, magnitudes eléctricas, calibración del micrómetro y uso del flexómetro.{"\n\n"}
        ...
        <View style={st.overlay}>
          <View style={st.podioBox}>
            <View style={st.podioHeader}>
              <Text style={st.podioTitle}>🏆 Podio Metrología</Text>
