...
const NIVEL_KEY_PROGRESO = NIVEL_KEY_API;
const ISLA_KEY           = 7;
const NUM_MODULES        = 4;
      ...
      <ImageBackground source={fondo} style={styles.bg} resizeMode="cover">
        ...
        <View style={styles.center}>
          <View style={styles.alertBox}>
            ...
            <TouchableOpacity style={[styles.btn, { marginTop: scaleDP(20) }]} onPress={() => router.replace("/LecturaOF")}>
      ...
      {showIntro && (
        <View style={styles.header}>
          <View style={styles.introBox}>
            ...
            <Text style={styles.descripcionIntro}>
              En este nivel deberás observar cada imagen y relacionarla con su concepto correcto.{"\n\n"}
      ...
      {showGame && mod && (
        <View style={styles.gameContent}>
          ...
          <View style={styles.boardRow}>
            ...
            <TouchableOpacity style={[styles.sideBtn, styles.btnGhost]} onPress={() => router.push("/LecturaOF")}>
        ...
        <View style={styles.overlay}>
          ...
          >
            ...
            <TouchableOpacity
              ...
              onPress={() => router.replace("/LecturaOF")}
            >
              <Text style={styles.btnText}>Continuar</Text>
            </TouchableOpacity>
            {(savedScore ?? score) < 70 && (
